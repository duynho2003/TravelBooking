...
import List from "../components/roomBookings/List";
import { useLocation, useNavigate, useParams } from "react-router-dom";
import Loading from "../components/common/Loading";
import { getAllRoomBookingsByUserId } from "../features/booking/BookingSlice";
...
export default function RoomBookings() {
  ...
  const roomBookings = useSelector((state) => state.bookings?.roomBookingsList);
  ...
  useEffect(() => {
    if (pagination && pagination.userId) {
      dispatch(getAllRoomBookingsByUserId(pagination))
        .then(() => {
          setTimeout(() => {
            setShowContent(true);
          }, 1000);
